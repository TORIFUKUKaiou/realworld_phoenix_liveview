defmodule RealworldPhoenixLiveviewWeb.Router do
  use RealworldPhoenixLiveviewWeb, :router

  import RealworldPhoenixLiveviewWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard("/dashboard", metrics: RealworldPhoenixLiveviewWeb.Telemetry)
    end
  end
